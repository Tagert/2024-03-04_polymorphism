...
import { IDrivable, IRefillable, IParkedStatus } from "./interfaces.js";

export class Car implements IDrivable, IRefillable, IParkedStatus {
  isParked: boolean;

  constructor({ isParked }: IParkedStatus) {
